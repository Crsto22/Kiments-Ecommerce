    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative flex min-h-[50vh] flex-col items-center justify-center overflow-hidden bg-[#eee9e2] px-7 sm:min-h-[60vh] sm:px-10 lg:px-16 xl:px-20 pt-20">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <h1 className="font-[family-name:var(--font-kiments)] text-[38px] font-normal tracking-[0.14em] text-black sm:text-[48px] lg:text-[64px] xl:text-[80px]">
            NOSOTROS
          </h1>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
            ...
            <div className="order-1 lg:order-2 flex flex-col justify-center text-[#242424]">
              <h2 className="text-2xl font-light uppercase tracking-[0.12em] sm:text-3xl lg:text-4xl">
                Nuestra Esencia
              </h2>
      ...
      <section className="bg-white px-7 py-20 sm:px-10 lg:px-16 xl:px-20 border-t border-black/5">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-2xl font-light uppercase tracking-[0.12em] sm:text-3xl text-[#242424]">
              Nuestros Valores
            </h2>
          ...
          <div className="grid gap-12 sm:grid-cols-3 lg:gap-16">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-[family-name:var(--font-kiments)] text-xl font-normal tracking-[0.08em] text-black mb-4">Elegancia Atemporal</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-[family-name:var(--font-kiments)] text-xl font-normal tracking-[0.08em] text-black mb-4">Calidad Premium</h3>
              <p className="text-sm font-light leading-relaxed text-black/60">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-[family-name:var(--font-kiments)] text-xl font-normal tracking-[0.08em] text-black mb-4">Autenticidad</h3>
              <p className="text-sm font-light leading-relaxed text-black/60">
      ...
      <section className="relative flex flex-col items-center justify-center overflow-hidden bg-[#111318] px-7 py-24 text-center text-white sm:px-10 lg:px-16 lg:py-32 xl:px-20">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          <h2 className="font-[family-name:var(--font-kiments)] text-3xl font-light tracking-[0.14em] sm:text-4xl lg:text-5xl">
            VISTE CON PROPÓSITO
          </h2>
